...
public class Seunjeon {
	
	public static void main(String[] args) {
        // 형태소 분석
        for (LNode node : Analyzer.parseJava("아버지가방에들어가신다.유리잔을소중히사용해주세요.오늘은기분이좋아")) {
        	System.out.println("=========================형태소분석 시작==========================");
            ...
            //품사
            System.out.println(node.morpheme().poses().head());
            System.out.println("=========================형태소분석 끝==========================");
        }
       ...
       /* Analyzer.setUserDict(Arrays.asList("덕후", "버카충,-100", "낄끼+빠빠,-100").iterator());
        for (LNode node : Analyzer.parseJava("덕후 냄새가 난다.")) {
